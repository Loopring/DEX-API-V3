...
case class SubmitOrderRequest(
  @ApiModelProperty(value = "交易所ID", example = "1", required = true) exchangeId: Int,
  @ApiModelProperty(value = "订单ID", example = "1", required = true) orderId: Int,
  @ApiModelProperty(value = "账号ID", example = "1", required = true) accountId: Int,
  @ApiModelProperty(value = "selling token id in exchange", example = "0",
    required = true) tokenSId: Int,
  @ApiModelProperty(value = "buying token id in exchange", example = "2",
    required = true) tokenBId: Int,
  @ApiModelProperty(value = "selling amount of token, decimal string in WEI",
    example = "1000000000000000000", required = true) amountS: String,
  @ApiModelProperty(value = "buying amount of token, decimal string in WEI",
    example = "1000000000000000000", required = true) amountB: String,
  @ApiModelProperty(value = "all or none", dataType = "boolean", example =
    "false") allOrNone: Option[Boolean] = None,
  @ApiModelProperty(value = "buy", dataType = "boolean", example = "true") buy: Option[Boolean] = None,
  @ApiModelProperty(value =
    "beginning period of this order, timestamp in second", example =
    "1567053142", required = true) validSince: Long,
  @ApiModelProperty(value = "ending period of this order, timestamp in second",
    example = "1567053142", required = true) validUntil: Long,
  @ApiModelProperty(value =
    "max accepted fee of this order, selling amount times x/10000",
    example = "20", required = true) maxFeeBips: Int,
  @ApiModelProperty(value = "label", example = "20", required = true) label: Long,
  @ApiModelProperty(value =
...
case class GetDepthResponse(
  @ApiModelProperty(value = "返回结果", required = true) resultInfo: ResultInfo = ResultInfo(),
  @ApiModelProperty(value = "深度信息") depth: Option[Depth] = Some(Depth()))
...
case class Depth(
  @ApiModelProperty(value = "版本号信息", example = "147", required = true) version: Long = 1234,
  @ApiModelProperty(value = "时间戳", example = "432312312", required = true) timestamp: Long = 43232,
  @ApiModelProperty(value = "卖单深度", required = true) bids: List[Slot] = List(Slot()),
  @ApiModelProperty(value = "买单深度", required = true, dataType = "List[Int]") asks: List[Int] = List.empty[Int])
...
case class Slot(
  @ApiModelProperty(value = "价格", example = "0.002", required = true) price: String = "0.002",
  @ApiModelProperty(value = "买方成交量", example = "21000", required = true) size: String = "21000",
  @ApiModelProperty(value = "卖方成交量", example = "33220000", required = true) volume: String = "332200000",
  @ApiModelProperty(value = "聚合的订单数目", example = "4", required = true) count: Int = 4)
